...
const Content = ({home}) => {
 ...
 const {setSeries, setMovies ,setHome ,data , series , movies, isLoading,error} = useStateContext()
    ...
    return (
      <div className="tiles-section"> 
        <div className="poster">
          <img src="https://alternativemovieposters.com/wp-content/uploads/2020/04/colm_wolfcreek.jpg" alt="placeHolder" />
        </div>
        <div className="tag">
